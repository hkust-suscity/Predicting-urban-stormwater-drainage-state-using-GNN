...
parser.add_argument('--device',type=str,default='cpu',help='') #update whether you use cpu or cuda
parser.add_argument('--expid',type=str,default='link_flow_len6_6_f_r',help='experiment id')
parser.add_argument('--data',type=str,default='dataset/link/link_flow_len6_6_f_r',help='data path')
...
parser.add_argument('--in_dim',type=int,default=3,help='inputs dimension')#two dimensions, network state and rainfall #add the third dimension: rainfall_30min_ahead
...
parser.add_argument('--adjdata',type=str,default='graphics/adj_mat_link.pkl',help='adj data path')#two pkl files for link or node, 'adj_mat_link.pkl' or 'adj_mat_node.pkl'
